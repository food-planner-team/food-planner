...
function closeModal() {
    ...
    if (isEdited.value) {
        newQuery = { ...route.query, refresh: true };
    }
...
async function openModal() {
    ...
    await getProductById(route.query.edit);
...
const updateProduct = async () => {
    ...
    try {
        await Product.updateProduct(route.query.edit, data);

        store.commit("Toast/addToast", {
            message: "Product został zaaaktualizowany",
            type: "success",
        });
